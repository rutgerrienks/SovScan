...
## 2026-06-29 22:10 — BBi-vraag gecorrigeerd naar rubricering (VIRBI) i.p.v. verwarrend "BBi"
- **Aanleiding (gebruiker):** "BBi" is geen zuivere term en in de code zelfs inconsistent (toelichting = "Departementaal Vertrouwelijk", info_text = "Bedrijfsvertrouwelijk"). Twee verschillende stelsels: BBN (BIO, níét gerubriceerd, publieke cloud bespreekbaar) vs rubricering Dep.V+ (VIRBI 2025, publieke cloud niet te accrediteren).
- **Wijziging in `backend/seed_questions.js`** (display_order 1): vraag herschreven naar *"Bevat de oplossing gerubriceerde informatie (Departementaal Vertrouwelijk of hoger, conform VIRBI 2025)?"*. toelichting/ko_reason/ko_mitigation/info_text bijgewerkt: KO van EU Cloud + Hyperscaler is nu correct gekoppeld aan rubricering, met expliciete afbakening dat BBN 1–3 hier NIET onder valt. Gewichten en KO-targets ongewijzigd.
